  ...
  return (
    <div class="flex flex-col">
      ...
      <div class="flex bg-[#E2F0E7] rounded-lg items-center justify-center px-4 py-[10px] gap-[10px]">
        ...
        />
        <span
          class="block w-[14px] h-4 border-2 border-gray-500 rounded"
          style={{
        ...
        <label
          for="meuCheckbox"
          className={`font-semibold text-[#0F9B3E] cursor-pointer p-3 rounded ${
    ...
    <>
      ...
      <div class="flex mx-auto p-16 w-full max-w-[1440px]">
        <div class="flex flex-col p-8 w-full gap-8">
          <h3 class="pt-4 text-xl font-semibold uppercase text-[#202020]">
