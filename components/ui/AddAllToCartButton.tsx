...
function AddAllToCartButton({ selectedProducts }: Props) {
  ...
  return (
    <div class="flex flex-col items-center justify-center gap-4">
        ...
        <button class="uppercase text-white font-semibold flex items-center text-center bg-[#0F9B3E] rounded-md border-[#17A087] px-4 py-[10px]" onClick={handleAddToCart}>Adicionar ao Carrinho</button>
    </div>
  );
}
